...
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.AEdge;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.AFace;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.ATesselation;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.AUnit;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CEdgeFaceSize;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CEdgeGranularity;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CEdgeNoTriangle;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CEdgeValidity;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CEdgesFacesContainPoints;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CFaceContainPoints;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CFaceNoTriangle;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CFaceSize;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CFaceValidity;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CUnitContainPoints;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CUnitNoNarrowGaps;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.CUnitNoTriangle;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.TesselationGeneralisation;
import eu.europa.ec.eurostat.eurogeostat.tesselationGeneralisation.TesselationGeneralisationSpecification;
