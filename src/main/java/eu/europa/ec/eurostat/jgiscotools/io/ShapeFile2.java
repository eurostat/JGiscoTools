...
public class ShapeFile2 {
	 ...
	 * @param path
	 */
	public ShapeFile2(String path){ open(path); }
	 ...
	 */
	public ShapeFile2(SimpleFeatureType ft, String folderPath, String fileName, boolean withSpatialIndex, boolean recreateOnExists){
		try {
	 ...
	 * @param recreateOnExists
	 */
	public ShapeFile2(String geomType, int epsgCode, String attributes, String folderPath, String fileName, boolean withSpatialIndex, boolean recreateOnExists){
	...
	//"NATUR_CODE = 'BAT'"
	public ShapeFile2 filter(String cqlString, String outPath, String outFile, boolean withSpatialIndex, boolean override){ return filter(getFilterFromCQL(cqlString), outPath, outFile, withSpatialIndex, override); }
	public ShapeFile2 filter(Filter filter, String outPath, String outFile, boolean withSpatialIndex, boolean override){
		int bufferSize = 500;
		ShapeFile2 shpOut = new ShapeFile2(getSchema(), outPath, outFile, withSpatialIndex, override);
		FeatureIterator<SimpleFeature> it = getFeatures(filter);
	...
	public ShapeFile2 add(Object... data) { return add(buildFeature(data)); }
	public ShapeFile2 add(SimpleFeature f) {
	...
	public ShapeFile2 add(SimpleFeatureCollection fs) {
		try {
	...
	public ShapeFile2 add(FeatureIterator<SimpleFeature> fit) { return add(100,fit); }
	public ShapeFile2 add(int bufferSize, FeatureIterator<SimpleFeature> fit) {
	...
	public ShapeFile2 add(String... shpPaths){ return add(100, shpPaths); }
	public ShapeFile2 add(int bufferSize, String... shpPaths){
		for(String shpPath : shpPaths){
			FeatureIterator<SimpleFeature> fit = new ShapeFile2(shpPath).dispose().getFeatures();
	...
	public ShapeFile2 remove(String cqlString){ return remove(getFilterFromCQL(cqlString)); }
	public ShapeFile2 remove(Filter f) {
