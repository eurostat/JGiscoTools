...
public class LakeQualityFix {
	...
	public static void main(String[] args) throws Exception {
		...
		//load input data
		Collection<Feature> lakes = SHPUtil.getFeatures("Y:\\JIRA-2019\\GISCO_2207_Lakes_100K\\LAKE_EURO_PL_100K_2019.shp");
		...
		//save
		SHPUtil.save(lakes, "Y:\\JIRA-2019\\GISCO_2207_Lakes_100K\\LAKE_EURO_PL_100K_2019_QC.shp", CRS.decode("EPSG:3035"));
