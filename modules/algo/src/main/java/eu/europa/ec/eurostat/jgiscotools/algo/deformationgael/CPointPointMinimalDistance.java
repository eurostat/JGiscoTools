...
public class CPointPointMinimalDistance extends GAELRelationnalConstraint {
	private static Logger logger = Logger.getLogger(CPointPointMinimalDistance.class.getName());

	private double distance;
	private SMSinglePoint ps1, ps2;

	public CPointPointMinimalDistance(SMSinglePoint ps1, SMSinglePoint ps2, double imp){
		this(ps1, ps2, imp, ps1.getPoint().getIniDistance(ps2.getPoint()));
	}

	public CPointPointMinimalDistance(SMSinglePoint ps1, SMSinglePoint ps2, double imp, double distance){
		super(ps1, ps2, imp);
		this.ps1 = ps1;
		this.ps2 = ps2;
