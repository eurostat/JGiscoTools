 ...
 *
 */
public class AccessibilityRoutingPaths2 {
	private static Logger logger = LogManager.getLogger(AccessibilityRoutingPaths2.class.getName());
	 ...
	 */
	public AccessibilityRoutingPaths2(Collection<Feature> cells, String cellIdAtt, double resM, Collection<Feature> pois, String poiIdAtt, Collection<Feature> networkSections,int nbNearestPOIs, double searchDistanceM) {
		this.cells = cells;
	...
	public static StatsHypercube computeStats(Collection<Feature> paths, String cellIdAtt) {
		...
		while(paths.size() >0) {
			...
			//sort paths
			paths_.sort(AccessibilityRoutingPaths2.pathDurationComparator);
