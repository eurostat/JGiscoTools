...
public class Test {
	...
	public static void main(String[] args) throws Throwable {
		...
		Collection<Feature> out = Decomposer.decomposeFeature(fs, true, 100, 1000, Partition.GeomType.ONLY_AREAS, 0);
		System.out.println(fs.size());
		...
		ArrayList<Feature> fs = GeoData.getFeatures("/home/juju/geodata/CNTR_2016/CNTR_RG_10M_2016_4258.shp");
		System.out.println(fs.size());
		Collection<Feature> out = Partition.getPartitionDataset(fs, true, 100000, 100, true, Partition.GeomType.ONLY_AREAS, 0);
		System.out.println(fs.size());
		System.out.println(out.size());
