...
import eu.europa.ec.eurostat.jgiscotools.gisco_processes.gridtiling.GriddedStatsTilerOld.TilingInfo.DimStat;
 ...
 */
public class GriddedStatsTilerOld {
	private static Logger logger = LogManager.getLogger(GriddedStatsTilerOld.class.getName());
	...
	public GriddedStatsTilerOld(int tileResolutionPix, String csvFilePath, String gridIdAtt, String statAttr) {
		this( tileResolutionPix, CSV.load(csvFilePath, statAttr), gridIdAtt, null, "");
	}

	public GriddedStatsTilerOld(int tileResolutionPix, StatsHypercube sh, String gridIdAtt, String dimLabel, String noValue) {
