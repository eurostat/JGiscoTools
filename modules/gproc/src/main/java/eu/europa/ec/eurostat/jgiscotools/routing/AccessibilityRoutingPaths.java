...
public class AccessibilityRoutingPaths {
	...
	//threshold values to compute accessibility indicators
	...
	public AccessibilityRoutingPaths(Collection<Feature> cells, String cellIdAtt, double resM, Collection<Feature> pois, Collection<Feature> networkSections, String populationAtt, double minDurAccMinT) {
		this.cells = cells;
