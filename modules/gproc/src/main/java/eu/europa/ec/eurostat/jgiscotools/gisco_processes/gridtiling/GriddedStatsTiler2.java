...
import eu.europa.ec.eurostat.jgiscotools.gisco_processes.gridtiling.GriddedStatsTiler2.TilingInfo.DimStat;
 ...
 */
public class GriddedStatsTiler2 {
	private static Logger logger = LogManager.getLogger(GriddedStatsTiler2.class.getName());
	...
	public GriddedStatsTiler2(String csvFilePath, String gridIdAtt, Coordinate originPoint, int tileResolutionPix, String noValue) {
		this( CSVUtil.load(csvFilePath), gridIdAtt, originPoint, tileResolutionPix, noValue);
	}

	public GriddedStatsTiler2(ArrayList<Map<String, String>> cells, String gridIdAtt, Coordinate originPoint, int tileResolutionPix, String noValue) {
		this.cells = cells;
